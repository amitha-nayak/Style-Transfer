...
def neural_style_transfer(config):
    ...
    out_dir_name = 'combined_' + \
        os.path.split(content_img_path)[1].split('.')[0] + '_' + \
    ...
    content_img = utils.prepare_img(content_img_path, config['height'], config['width'], device)
    style_img = utils.prepare_img(style_img_path, config['height'], config['width'], device)
